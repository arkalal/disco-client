...
export default function TermsBrands() {
  useEffect(() => {
      ...
      <div className={styles.contentWrapper}>
        <div className={styles.content}>
          ...
          <p className={styles.paragraph}>
            ...
            promote their brands, products or services. DISCO has distinct
            products and services to cater to various requirements. Disco Scout
            (Built to Help You Discover, Qualify, and Collaborate with Real and
            Relevant Influencers and Content Creators), Disco Radar (listen to
            both paid and organic influencer conversations about your brand)
            Disco Recon (helps benchmark your influencer program's long-term
            performance, monitor competition, and follow topics for content
            inspiration) Disco Rewards you can give online influencers branded
            experiences and inspire them to share your brand's message.
          </p>
          ...
          {/* The content continues with more sections */}
          ...
          <p className={styles.paragraph}>
            ...
            page and/or by authorizing the use of your credit or debit card for
            payment of such charges and fees necessary to create an Account or
            purchase a Subscription through Service and for any other charges
            which you may incur.
          </p>
        </div>
      </div>
